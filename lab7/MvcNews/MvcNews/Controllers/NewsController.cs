...
namespace MvcNews.Controllers
{
    public class NewsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Text,TimeStamp,RowVersion")] NewsItem newsItem)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Text,TimeStamp,RowVersion")] NewsItem newsItem)
        {
            if (id != newsItem.Id)
            {
                return NotFound();
            ...
            if (ModelState.IsValid)
            {
                ...
                catch (DbUpdateConcurrencyException e)
                {
                    ...
                    {
                        ModelState.AddModelError("", "Modified data has been changed or deleted by another user");
